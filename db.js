// ============================================================
// db.js - Lavie Spa Data Layer v3  (plain script, no modules)
// ============================================================

(function(global) {
  'use strict';

  var DB_KEY = 'laviespa_v3';
  ...
  var DEFAULT_DATA = {
    ...
    menus: [
      // ── c1 Massage Trị Liệu ──
      { id:'m1',  catId:'c1', active:true, nameVi:'Massage cổ vai gáy trị liệu',
        descVi:'Ngâm chân thảo dược + massage cổ vai gáy - tay + đá nóng + dầu trị liệu + đắp mắt thảo dược',
        prices:[{duration:'60',amount:250000},{duration:'90',amount:300000}], translations:{} },
      { id:'m2',  catId:'c1', active:true, nameVi:'Đả thông kinh lạc lưng vai cổ gáy - tay chuyên sâu',
        descVi:'Ngâm chân thảo dược + massage trị liệu + dầu trị liệu + đá nóng + đắp mắt thảo dược + xông hơi',
        prices:[{duration:'90',amount:350000}], translations:{} },
      { id:'m3',  catId:'c1', active:true, nameVi:'Massage chân thư giãn',
        descVi:'Ngâm chân thảo dược + massage + đá nóng + đắp mắt thảo dược',
        prices:[{duration:'60',amount:250000}], translations:{} },
      { id:'m4',  catId:'c1', active:true, nameVi:'Massage chân trị liệu',
        descVi:'Ngâm chân thảo dược + massage + dầu trị liệu + đá nóng + đắp cao thảo dược + đắp mắt thảo dược',
        prices:[{duration:'90',amount:350000}], translations:{} },
      { id:'m5',  catId:'c1', active:true, nameVi:'Massage trị liệu thắt lưng eo',
        descVi:'Ngâm chân thảo dược + massage thắt lưng eo - chân + dầu trị liệu + đá nóng + đắp cao thảo dược + đắp mắt thảo dược',
        prices:[{duration:'60',amount:350000},{duration:'90',amount:450000}], translations:{} },
      // ── c2 Body Massage ──
      { id:'m6',  catId:'c2', active:true, maleExtra:50000, nameVi:'Massage Body Aroma Therapy',
        descVi:'Ngâm chân thảo dược + massage + đắp mắt thảo dược',
        prices:[{duration:'70',amount:300000}], translations:{} },
      { id:'m7',  catId:'c2', active:true, maleExtra:50000, nameVi:'Massage Body đá nóng',
        descVi:'Ngâm chân thảo dược + massage + đá nóng + đắp mắt thảo dược',
        prices:[{duration:'90',amount:350000}], translations:{} },
      { id:'m8',  catId:'c2', active:true, maleExtra:50000, nameVi:'Massage Body trị liệu',
        descVi:'Ngâm chân thảo dược + massage + đá nóng + dầu trị liệu + xông hơi',
        prices:[{duration:'110',amount:400000}], translations:{} },
      { id:'m9',  catId:'c2', active:true, maleExtra:50000, nameVi:'Massage Body Thụy Điển (chuyên sâu)',
        descVi:'Ngâm chân thảo dược + massage + đá nóng + dầu trị liệu + đắp cao thảo dược',
        prices:[{duration:'120',amount:450000}], translations:{} },
      { id:'m10', catId:'c2', active:true, nameVi:'Massage bầu dưỡng sinh',
        descVi:'Massage chuyên biệt cho bà bầu',
        prices:[{duration:'60',amount:300000},{duration:'90',amount:350000},{duration:'120',amount:450000}], translations:{} },
      { id:'m11', catId:'c2', active:true, nameVi:'Xông hơi đá muối',
        descVi:'Xông hơi với đá muối himalaya',
        prices:[{duration:'20-40',amount:150000}], translations:{} },
      // ── c3 Diện Chẩn ──
      { id:'m12', catId:'c3', active:true, promo:true, nameVi:'Mặt',
        descVi:'Diện chẩn vùng mặt',
        prices:[{duration:'45-60',amount:200000}], translations:{} },
      { id:'m13', catId:'c3', active:true, promo:true, nameVi:'Vai gáy',
        descVi:'Diện chẩn vùng vai gáy',
        prices:[{duration:'60',amount:250000},{duration:'90',amount:300000}], translations:{} },
      { id:'m14', catId:'c3', active:true, promo:true, nameVi:'Lưng',
        descVi:'Diện chẩn vùng lưng',
        prices:[{duration:'60',amount:350000}], translations:{} },
      { id:'m15', catId:'c3', active:true, promo:true, nameVi:'Full body',
        descVi:'Diện chẩn toàn thân',
        prices:[{duration:'120',amount:400000},{duration:'150',amount:500000}], translations:{} },
      // ── c4 Gội Đầu ──
      { id:'m16', catId:'c4', active:true, nameVi:'Combo 1',
        descVi:'Ngâm chân thảo dược + massage cổ vai gáy + đắp mắt thảo dược + dẫn khí trị liệu + gội đầu thảo dược',
        prices:[{duration:'60',amount:150000}], translations:{} },
      { id:'m17', catId:'c4', active:true, nameVi:'Combo 2',
        descVi:'Ngâm chân thảo dược + massage cổ vai gáy + đắp mắt thảo dược + dẫn khí trị liệu + đắp mặt nạ + gội đầu thảo dược',
        prices:[{duration:'70',amount:180000}], translations:{} },
      { id:'m18', catId:'c4', active:true, nameVi:'Combo 3',
        descVi:'Ngâm chân thảo dược + massage cổ vai gáy - tay chuyên sâu + đắp mắt thảo dược + dẫn khí trị liệu + đắp mặt nạ + gội đầu thảo dược',
        prices:[{duration:'90',amount:250000}], translations:{} },
      { id:'m19', catId:'c4', active:true, nameVi:'Combo 4',
        descVi:'Ngâm chân thảo dược + massage cổ vai gáy - tay chuyên sâu + đắp mắt thảo dược + dẫn khí trị liệu + đắp mặt nạ + gội đầu thảo dược',
        prices:[{duration:'110',amount:350000}], translations:{} },
      { id:'m20', catId:'c4', active:true, nameVi:'Combo 5',
        descVi:'Ngâm chân thảo dược + massage cổ vai gáy - tay chuyên sâu + massage mặt + đắp cao thảo dược + đắp mắt thảo dược + dẫn khí trị liệu + gội đầu thảo dược',
        prices:[{duration:'120',amount:400000}], translations:{} },
      { id:'m21', catId:'c4', active:true, nameVi:'Combo 6',
        descVi:'Ngâm chân thảo dược + massage cổ vai gáy + massage tay chuyên sâu + massage chân + xông hơi hút mụn bã nhờn + đắp mắt thảo dược + dẫn khí trị liệu + massage mặt + đắp mặt nạ + gội đầu thảo dược',
        prices:[{duration:'140',amount:450000}], translations:{} },
      // ── c5 Chăm Sóc Da ──
  ...
  function loadDB() {
    try {
      ...
      if (!raw) {
        var fresh = deepClone(DEFAULT_DATA);
        saveDB(fresh);
        return fresh;
      }
      return JSON.parse(raw);
    } catch(e) {
      var fresh2 = deepClone(DEFAULT_DATA);
      saveDB(fresh2);
      return fresh2;
    }
  }
  ...
  function saveDB(data) {
    try { localStorage.setItem(DB_KEY, JSON.stringify(data)); } catch(e) { console.error('saveDB error', e); }
  }
  ...
  async function translateToAllLangs(viText) {
    ...
    var prompt = 'Translate this Vietnamese spa service text to 7 languages.\n' +
      'Return ONLY valid JSON, no markdown, no explanation.\n' +
      'Vietnamese: "' + viText + '"\n' +
      'Return: {"ko":"...","en":"...","ja":"...","zh":"...","th":"...","ms":"...","ru":"..."}';
    try {
  ...
  global.DB = {
    ...
    backupDB: backupDB,
    restoreDB: restoreDB,
    translateToAllLangs: translateToAllLangs,
